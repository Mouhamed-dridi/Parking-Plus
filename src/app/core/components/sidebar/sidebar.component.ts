    ...
    <div class="menu-section">
      ...
      <ul nz-menu nzMode="inline" [nzTheme]="'light'" [nzSelectable]="true">
        ...
        <li nz-submenu nzTitle="Cars / Vehicles" nzIcon="car" nzOpen>
          <ul>
            <li nz-menu-item nzMatchRouter routerLink="/listing" [queryParams]="{category: 'pickup'}">Pickup</li>
            <li nz-menu-item nzMatchRouter routerLink="/listing" [queryParams]="{category: 'delivery'}">Delivery</li>
            <li nz-menu-item nzMatchRouter routerLink="/listing" [queryParams]="{category: 'trucks'}">Trucks</li>
            <li nz-menu-item nzMatchRouter routerLink="/listing" [queryParams]="{category: 'DG cars'}">DG cars</li>
          </ul>
        </li>
